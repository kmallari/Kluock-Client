          ...
          <li className='px-2 flex flex-row gap-2 items-center py-2 justify-between text-start bg-slate-100 w-full my-2 rounded-lg hover:bg-slate-200 cursor-pointer group/container'>
            ...
            <div className='group/copy relative'>
              <div className='invisible group-hover/copy:visible absolute  top-0 bottom-0 my-auto'>
                <div className='absolute w-3 h-3 bg-blue-700 right-0 rotate-45 top-0 bottom-0 my-auto -left-5'></div>
                <div className='bg-blue-700 text-white font-medium text-xs  h-fit px-2 py-1 rounded-md top-1 absolute -left-20'>
                  Copy info
                </div>
              </div>

              <button className='p-2 rounded-lg hover:bg-blue-300 hidden group-hover/container:block'>
                <BiCopy />
              </button>
            </div>
          </li>
